...
class RecipeImageRemoteDataSourceImplTest {
    ...
    lateinit var mockFireStorageDaoImpl: FirebaseStorageDaoImpl
    lateinit var recipeImageRemoteDataSourceImpl: RecipeImageRemoteDataSourceImpl
    ...
    fun fetchRecipeImage_getImageByteArray_true(): Unit = runBlocking {
        //given
        `when`(mockFireStorageDaoImpl.fetchRecipeImage(testUri)).thenReturn(Result.success(testByteArray))
        //when
