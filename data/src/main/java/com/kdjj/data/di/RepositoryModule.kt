...
abstract class RepositoryModule {
	...
	@Binds
	@Singleton
	internal abstract fun bindRecipeTypeRepository(recipeTypeRepositoryImpl: RecipeTypeRepositoryImpl): RecipeTypeRepository
	
	@Binds
	@Singleton
	internal abstract fun bindRecipeRepository(recipeRepositoryImpl: RecipeRepositoryImpl): RecipeRepository
    
    @Binds
    @Singleton
    internal abstract fun bindRecipeImageRepository(recipeImageRepositoryImpl: RecipeImageRepositoryImpl): RecipeImageRepository
}
