...
abstract class UseCaseModule {
	...
	@Binds
	internal abstract fun bindDeleteRecipeUseCase(deleteRecipeUseCase: DeleteRecipeUseCase): UseCase<DeleteRecipeRequest, Boolean>
	...
	@Binds
	internal abstract fun bindSaveRecipeUseCase(saveRecipeUseCase: SaveRecipeUseCase): UseCase<SaveRecipeRequest, Boolean>
	
	@Binds
	internal abstract fun bindUpdateRecipeFavoriteUseCase(updateRecipeFavoriteUseCase: UpdateRecipeFavoriteUseCase): UseCase<UpdateRecipeFavoriteRequest, Boolean>
}
